...
awful.Populate({
    FearWard        = Spell(6346, { beneficial = true }),
    DesperatePrayer = Spell(48173, { ignoreMoving = true, heal = true }),
    ...
    VampiricTouch   = Spell(48160, { ignoreFacing = true, damage = "magic" }),
    MindFlay        = Spell(48156, { damage = "magic" }),
    DevouringPlague = Spell(48300, { ignoreFacing = true, damage = "magic" }),
    ShadowWordPain  = Spell(48125, { ignoreFacing = true, damage = "magic" }),
    HolyNova        = Spell(48078, { radius = 10, ignoreCasting = true, ignoreChanneling = true }),
    ShackleUndead   = Spell(10955, { ignoreFacing = true, cc = true }),
    PsychicScream   = Spell(10890, { ignoreFacing = true, cc = "fear", effect = "magic" }),
    MassDispel      = Spell(32375, { ignoreFacing = true, radius = 15 }),
    DispelMagic     = Spell(988, { ignoreFacing = true, effect = true }),
    InnerFire       = Spell(48168, { beneficial = true }),
    AutoAttack      = Spell(6603, { ignoreChanneling = true, ignoreCasting = true }),
    ShadowWordDeath = Spell(48158, { damage = "magic", ignoreFacing = true, ignoreCasting = true, ignoreChanneling = true }),
